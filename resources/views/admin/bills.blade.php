<x-layouts.app>
    ...
    <div
        class="mt-8 overflow-hidden rounded-xl border border-gray-200 bg-white py-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">

        <a class="ml-3 text-sm text-gray-500" href="{{ route('bills.generate') }}">
            <button class="rounded bg-indigo-600 px-6 py-2 text-white">Auto Generate Bill
            </button>
        </a>
    </div>
                ...
                <tbody class="divide-y dark:divide-gray-700">
                    @forelse($bills as $bill)
                        <tr class="hover:bg-indigo-50/50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-6 py-4 text-right capitalize">
                                {{ $bill->status }}
                            </td>
                            <td class="px-6 py-4 text-right">
